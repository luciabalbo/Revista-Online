            ...
            {['Arte y Cultura', 'Feminismo y Politica', 'Streaming', 'Nosotras'].map((item) => (
              ...
              >
                <div className="relative overflow-hidden h-[20px] flex flex-col justify-start"> 
                  ...
                  <span className="absolute top-full left-0 text-[#4F136C] transition-transform duration-500 group-hover:-translate-y-full text-sm tracking-normal font-montserrat">{item}</span>
                </div>
              </Link>
            ))}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div 
            ...
            className="fixed inset-0 bg-[#4F136C] z-[500] flex flex-col items-center justify-center lg:hidden"
          >
            {/* BOTÓN CERRAR */}
            <button 
